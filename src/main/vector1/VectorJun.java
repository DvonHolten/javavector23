...
public class VectorJun {
    ...
    public static void main( String[] args ) {
        ...
        System.out.printf(" time was %d microSecs %n", (intAddEnd - intAddStart)/1000 );
        System.out.printf(" time was %d microSecs %n", (fltAddEnd - fltAddStart)/1000 );
        System.out.printf(" time was %d microSecs %n", (dblAddEnd - dblAddStart)/1000 );
        ...
        System.out.printf(" time was %d microSecs %n", (intMulEnd - intMulStart)/1000 );
        System.out.printf(" time was %d microSecs %n", (fltMulEnd - fltMulStart)/1000 );
        System.out.printf(" time was %d microSecs %n", (dblMulEnd - dblMulStart)/1000 );
